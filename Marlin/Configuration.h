...
There will be various comments made throughout this file and will have the Marlin FW 
* If there is a comment made by me then it will say Hydrix on there and will have explanations
* Please note: The configuration is for my own setup but will be possible to change some settings to suit your own
* My setup is: 
- Creality Ender 5 pro (Came with the GD Board)

*Upgrades:
* - Creality Tempered Glass Bed
* - CR Touch (Should work with the BL Touch config)
* - BTT SKR Mini E3 V3
* - BTT TFT35 V3 Screen
*/
...
#define STRING_CONFIG_H_AUTHOR "(Hydrix, Ender-5 Pro)" // Who made the changes.
...
//Hydrix: As of 19th January 2023, Marlin repo has the BTT SKR Mini E3 V3 board and there is another version V3_01 which has a different chip so please check yours
...
//HYDRIX: The default Baudrate is 115200
...
//HYDRIX: This is also another serial port that has been enabled
...
//Keeping this to simply say Ender-5 Pro but can add whatever you want
#define CUSTOM_MACHINE_NAME "Hydrix Ender-5 pro"
...
//HYDRIX: The Stepper drivers are the TMC2209 for this board
 ...
 *
 */
//HYDRIX: Temp sensor 0 is value of 1 as standard and bed also will have temp sensor marked as value 1
...
//HYDRIX: I have a CR Touch therefore won't need to use the Z stop plug however I may still keep it active but not have it plugged into the physical board.
...
//HYDRIX: By default from my previous config but the 93 value may need to be adjusted after calibration
...
//CR Touch needs the Z stop plug to be removed therefore we need to specify the probe pin for the board which is PC14
...
/*
HYDRIX: Here is the code for the CR Touch, this will be needed to allow for Auto Bed Levelling
*/
...
/*
HYDRIX: Nozzle to probe offset may be the same but best to check yours with a ruler.
Measure the distances of the probe end to the hotend nozzle
Mine sits on the left and slightly in front of the nozzle, I used a digital vernier calliper
Measured in mm
*/
...
//HYDRIX: This is a Creality Glass bed that is 235mm x 235mm and 4mm thick
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //HYDRIX: This will have 9 points in total for max points set to 3 (3*3=9)
